<template>
  <div class="restocking">
    <div class="page-header">
      ...
      <p>
        Allocate your budget and get recommended items to restock based on
        demand forecasts.
      </p>
    </div>
    ...
    <div class="card">
      <div class="card-header">
        ...
        <span class="items-count-badge"
          >{{ recommendedItems.length }} items</span
        >
      </div>
      ...
      <div v-else>
        <div
          v-if="budget === 0 || recommendedItems.length === 0"
          class="empty-state"
        >
          <p v-if="budget === 0">
            Set a budget above to see recommended restocking items.
          </p>
          <p v-else>
            ...
            <tbody>
              <tr v-for="item in recommendedItems" :key="item.item_sku">
                ...
                <td>
                  <strong
                    >${{
                      (item.forecasted_demand * item.unit_price).toLocaleString(
                        undefined,
        ...
        <div class="order-summary">
          <div class="summary-row">
            <span class="summary-label"
              >{{ recommendedItems.length }} items recommended</span
            >
